...
print(f'El empleado1 se llama {empleado1.get_nombre()}, tiene {empleado1.get_edad()} años y cobra {empleado1.get_sueldo()} pesos.')
...
print(f'El empleado2 se llama {empleado2.get_nombre()}, tiene {empleado2.get_edad()} años y cobra {empleado2.get_sueldo()} pesos.')