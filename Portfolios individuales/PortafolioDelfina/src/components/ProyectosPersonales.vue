...
misProyectos.value = ([
    {
        id: 1,
        src: proyecto1,
        titulo: "Blog Personal (2025)",
        descripcion: "Portafolio personal con html y css para el primer trimestre de TUP",
        proyectoLink: "https://portafolio-git-main-delfinamulinettigmailcoms-projects.vercel.app/",
        githubLink: "https://github.com/DelfinaMulinetti/portafolio",
    }
])
</script>
...
background: rgba(255, 255, 255, 0); /* Blanco con transparencia */
