...
misProyectos.value = ([        
    {
        ...
        proyectoLink: "https://rocio-lucero-vue.netlify.app/",
        githubLink: "https://github.com/rocio2102/Portafolio-Vue",
    }    
])
</script>
...
.galeria {
    ...
    background: linear-gradient(-45deg, #452a49, #723f7a, #7e4e7e, #b0adb1);
